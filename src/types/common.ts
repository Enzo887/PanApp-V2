...
export type CrearDetallesBody = Omit<DetallesJornada, 'id' | 'jornada_id' | 'precio_unitario'>
...
export type CrearJornadaBody = Omit<Jornada, 'id' | 'estado'> & {detalles: CrearDetallesBody[]}

export type JornadaDetalles = Jornada & { detalles: DetalleCompleto[] }